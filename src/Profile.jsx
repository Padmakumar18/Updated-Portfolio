import myPhoto from "./assets/MyPicture1.webp";
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center min-h-screen text-white">
      <div className="text-center md:text-left">
        <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-teal-400 Name">
          Padma Kumar
        </p>
      ...
      <div className="md:w-1/2 flex justify-center mt-6 md:mt-0">
        <LazyLoadImage
          src={myPhoto}
          alt="Profile"
          className="w-30 h-30 md:w-60 md:h-60 lg:w-80 lg:h-80 rounded-full object-cover filter brightness-90 transition-transform duration-300 hover:scale-110 MyPicture"
        />
      </div>
    </div>
  );
